...
- #353: Updated nholuongut/semver which included bug fixes
...
- Upgraded `nholuongut/goutils` to `v1.1.1`. see the [Security Advisory](https://github.com/nholuongut/goutils/security/advisories/GHSA-xg2h-wx96-xgxr)
