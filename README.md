...
* v2 is the previous stable release series. It has been more than three years since
  ...
  on the [release-2](https://github.com/nholuongut/sprig/tree/release-2) branch.
  Bug fixes to this major version will continue for some time.

## Usage

**Template developers**: Please use Sprig's [function documentation](https://github.com/nholuongut/sprig/) for
detailed instructions and code snippets for the >100 template functions available.

**Go developers**: If you'd like to include Sprig as a library in your program,
our API documentation is available [at GoDoc.org](https://github.com/nholuongut/sprig).
...
import (
  "github.com/nholuongut/sprig/v3"
  "html/template"
)
